...
type TbContractBindAddress struct {
	...
	Address         string    `json:"address" gorm:"column:address;type:varchar(128);COMMENT:" name:""`                   // 钱包地址
	ContractAddress string    `json:"contract_address" gorm:"column:contract_address;type:varchar(128);COMMENT:" name:""` // 合约代币地址
