...
type SyncBlockChainServiceV2 struct {
	...
	counter *ethm.SyncBlockNumberCounterV2
}

func NewSyncBlockChainServiceV2(ethMng *ethm.EthereumManager, counter *ethm.SyncBlockNumberCounterV2) *SyncBlockChainServiceV2 {
