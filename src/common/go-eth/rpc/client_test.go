...
// This test reproduces https://github.com/ville-vv/eth-chain-store/src/common/go-ethereum/issues/17837 where the
...
// It is the reproducer for https://github.com/ville-vv/eth-chain-store/src/common/go-ethereum/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-eth-test-ipc-%d-%d", os.Getpid(), rand.Int63())
