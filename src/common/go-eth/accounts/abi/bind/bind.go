...
//
// Detailed usage document and tutorial available on the go-eth Wiki page:
// https://github.com/ville-vv/eth-chain-store/src/common/go-ethereum/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
