...
import (
	...
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/accounts/scwallet"
	...
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/consensus/misc"
...
// NewPublicTxPoolAPI creates a new tx pool server that gives information about the transaction pool.
...
//
// https://github.com/ville-vv/eth-chain-store/src/common/go-ethereum/wiki/Management-APIs#personal_sign
...
//
// https://github.com/ville-vv/eth-chain-store/src/common/go-ethereum/wiki/Management-APIs#personal_ecRecover
...
// NewPublicTransactionPoolAPI creates a new RPC server with methods specific for the transaction pool.
