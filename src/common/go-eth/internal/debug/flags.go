...
var (
	...
	backtraceAtFlag = cli.StringFlag{
		Name:  "log.backtrace",
		Usage: "Request a stack trace at a specific logging statement (e.g. \"ethereum.go:271\")",
		Value: "",
	}
	...
	legacyBacktraceAtFlag = cli.StringFlag{
		Name:  "backtrace",
		Usage: "Request a stack trace at a specific logging statement (e.g. \"ethereum.go:271\") (deprecated, use --log.backtrace)",
		Value: "",
	}
