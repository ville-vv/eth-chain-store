...
// Reset clears the internal state of a peer ethm.
...
// MarkLacking appends a new ethm to the set of items (blocks, receipts, states)
...
// actions to/from that particular ethm.
