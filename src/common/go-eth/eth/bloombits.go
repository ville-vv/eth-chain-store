...
import (
	...
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/common/bitutil"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/core/rawdb"
)

const (
	// bloomServiceThreads is the number of goroutines used globally by an Ethereum
	// instance to server bloombits lookups for all running filters.
	...
	// bloomRetrievalBatch is the maximum number of bloom bit retrievals to server
	// in a single batch.
