...
import (
	...
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/eth/tracers/internal/tracers"
)
...
// init retrieves the JavaScript transaction tracers included in go-eth.
func init() {
