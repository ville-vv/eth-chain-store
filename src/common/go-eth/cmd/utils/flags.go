...
// This file is part of go-eth.
//
// go-eth is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// go-eth is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU General Public License for more details.
//
// You should have received a copy of the GNU General Public License
// along with go-eth. If not, see <http://www.gnu.org/licenses/>.

// Package utils contains internal helper functions for go-eth commands.
package utils
...
import (
	...
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/accounts"
	...
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/consensus"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/consensus/clique"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/consensus/ethash"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/core"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/core/rawdb"
	...
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/eth/gasprice"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/eth/tracers"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/ethdb"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/ethstats"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/graphql"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/internal/ethapi"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/internal/flags"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/les"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/log"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/metrics"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/metrics/exp"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/metrics/influxdb"
	...
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/p2p/nat"
	"github.com/ville-vv/eth-chain-store/src/common/go-eth/p2p/netutil"
...
var (
	...
	EthStatsURLFlag = cli.StringFlag{
		Name:  "ethstats",
		Usage: "Reporting URL of a ethstats server (nodename:secret@host:port)",
	}
	...
	// Since the pprof server enables sensitive/vulnerable behavior, this allows a user
...
func RegisterEthService(stack *node.Node, cfg *ethconfig.Config) (ethapi.Backend, *eth.Ethereum) {
	if cfg.SyncMode == downloader.LightSync {
		...
		if err != nil {
			Fatalf("Failed to register the Ethereum server: %v", err)
		}
...
func RegisterEthStatsService(stack *node.Node, backend ethapi.Backend, url string) {
	if err := ethstats.New(stack, backend, backend.Engine(), url); err != nil {
		Fatalf("Failed to register the Ethereum Stats server: %v", err)
	}
}

// RegisterGraphQLService is a utility function to construct a new server and register it against a node.
func RegisterGraphQLService(stack *node.Node, backend ethapi.Backend, cfg node.Config) {
	if err := graphql.New(stack, backend, cfg.GraphQLCors, cfg.GraphQLVirtualHosts); err != nil {
		Fatalf("Failed to register the GraphQL server: %v", err)
	}
}
